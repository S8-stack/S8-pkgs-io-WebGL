...
WebGL_Shape.prototype = {
		...
		initialize(scene){
			...
			request("service=WebGL; action=GetShape; id="+shape.id, function (request){
				...
				requestTypedArray("service=WebGL; action=GetVertexArraysBlock; id="+shape.id, function (request){
				...
				requestTypedArray("service=WebGL; action=GetElementArray; id="+shape.id, function (request){
